...
- Do not demand confirmations unless the contract or task requires them.
...
## 4. Handling Pauses and Contract-Based Feedback Points
If a contract or workflow requires a pause, the agent must:
...
Example tone:  
> “I’m pausing here because the contract requires a review of the design summary.  
